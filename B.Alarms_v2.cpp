...
tuple_i32 ReadTime() {
    ...
    tuple_i32 date = {day, hour, minute};
    return date;
}

tuple_i32 GetNextSignalTime(const tuple_i32& alarm_time, const tuple_i32& now_time) {
    auto [alarm_day, alarm_hour, alarm_minute] = alarm_time;
